document.addEventListener("DOMContentLoaded", () => {
    ...
    function initThreeJs(modalId) {
        ...
        // renderers[modalId].setClearColor(0x000000, 0); // 背景透明
        renderers[modalId].setClearColor(0xE1D1C4, 1); // 背景色
    ...
    function loadModel(modalId) {
        const modelPaths = {
            modal1: 'gltf/50円チョコ.glb',
            modal2: 'gltf/patipati_kora.glb',
            modal3: 'gltf/sunnpou.gltf',
            modal4: 'gltf/ミニコーラ.glb',
            modal5: 'gltf/アルフォート-チョコ.glb',
            modal6: 'gltf/ポッキー.glb'
        };
