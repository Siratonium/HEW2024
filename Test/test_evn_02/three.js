...
const addModelButton5 = document.getElementById('add-model-button-5'); 
const addModelButton6 = document.getElementById('add-model-button-6'); 
const addModelButton7 = document.getElementById('add-model-button-7'); 
const addModelButton8 = document.getElementById('add-model-button-8');
const addModelButton9 = document.getElementById('add-model-button-9'); 
const addModelButton10 = document.getElementById('add-model-button-10'); 
const addModelButton11 = document.getElementById('add-model-button-11'); 
const addModelButton12 = document.getElementById('add-model-button-12');
const addModelButton13 = document.getElementById('add-model-button-13');
...
addModelButton5.addEventListener('click', () => { 
  Model_E();
});

addModelButton6.addEventListener('click', () => { 
  Model_F();
});

addModelButton7.addEventListener('click', () => { 
  Model_G();
});

addModelButton8.addEventListener('click', () => { 
  Model_H();
});

addModelButton9.addEventListener('click', () => { 
  Model_I();
});

addModelButton10.addEventListener('click', () => { 
  Model_J();
});

addModelButton11.addEventListener('click', () => { 
  Model_K();
});

addModelButton12.addEventListener('click', () => { 
  Model_L();
});

addModelButton13.addEventListener('click', () => { 
  Model_M();
});
...
function Model_F() {
  ...
  const loader = new THREE.GLTFLoader();
  loader.load('gltf/sakumaame.glb', function(gltf) { 
    additionalModel = gltf.scene;
    additionalModel.scale.set(1, 1, 1); 
    additionalModel.position.set(0, 1, 0); 
    scene.add(additionalModel);
...
function Model_G() {
  ...
  const loader = new THREE.GLTFLoader();
  loader.load('gltf/50yen-tyoko.glb', function(gltf) { 
    additionalModel = gltf.scene;
    additionalModel.scale.set(1, 1, 1); 
    additionalModel.position.set(0, 1, 0); 
    scene.add(additionalModel);
...
function Model_H() {
  ...
  const loader = new THREE.GLTFLoader();
  loader.load('gltf/patipati_budou.glb', function(gltf) { 
    additionalModel = gltf.scene;
    additionalModel.scale.set(1, 1, 1); 
    additionalModel.position.set(0, 1, 0); 
    scene.add(additionalModel);
...
function Model_I() {
  ...
  const loader = new THREE.GLTFLoader();
  loader.load('gltf/patipati_soda.glb', function(gltf) { 
    additionalModel = gltf.scene;
    additionalModel.scale.set(1, 1, 1); 
    additionalModel.position.set(0, 1, 0); 
    scene.add(additionalModel);
...
function Model_J() {
  ...
  const loader = new THREE.GLTFLoader();
  loader.load('gltf/patipati_kora.glb', function(gltf) { 
    additionalModel = gltf.scene;
    additionalModel.scale.set(1, 1, 1); 
    additionalModel.position.set(0, 1, 0); 
    scene.add(additionalModel);
...
function Model_K() {
  ...
  const loader = new THREE.GLTFLoader();
  loader.load('gltf/yo-guretto.glb', function(gltf) { 
    additionalModel = gltf.scene;
    additionalModel.scale.set(1, 1, 1); 
    additionalModel.position.set(0, 1, 0); 
    scene.add(additionalModel);
...
function Model_L() {
  ...
  const loader = new THREE.GLTFLoader();
  loader.load('gltf/aaaa.gltf', function(gltf) { 
    additionalModel = gltf.scene;
    additionalModel.scale.set(1, 1, 1); 
    additionalModel.position.set(0, 1, 0); 
    scene.add(additionalModel);
